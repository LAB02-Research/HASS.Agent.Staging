...
namespace HASS.Agent.Shared.Managers
{
    ...
    /// </summary>
    public static class WindowsUpdatesManager
    {
        ...
        /// </summary>
        /// <returns></returns>
        public static (List<WindowsUpdateInfo> driverUpdates, List<WindowsUpdateInfo> softwareUpdates) GetAvailableUpdates()
        {
            try
            {
