...
{
    /// <summary>
    /// Gathers information regarding the user's Windows session
    /// Sources:
            ...
            try
            {
                ...
                if (OsIsWin7)
                {
                    ...
                    * */
                    ...
                    {
                        WTS_SESSIONSTATE_LOCK => LockState.Unlocked,
                        WTS_SESSIONSTATE_UNLOCK => LockState.Locked,
                        _ => LockState.Unknown
                    };
                }
                ...
                return lockState switch
                {
                    WTS_SESSIONSTATE_LOCK => LockState.Locked,
                    WTS_SESSIONSTATE_UNLOCK => LockState.Unlocked,
                    _ => LockState.Unknown
                };
            }
            catch (Exception ex)
