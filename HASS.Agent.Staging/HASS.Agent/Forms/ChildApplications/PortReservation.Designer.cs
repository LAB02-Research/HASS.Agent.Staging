...
namespace HASS.Agent.Forms.ChildApplications
{
    partial class PortReservation
    {
        ...
        private void InitializeComponent()
        {
            ...
            // PbStep1PortBinding
            // 
            this.PbStep1PortBinding.AccessibleDescription = "Step one status visualisation.";
            this.PbStep1PortBinding.AccessibleName = "Step one status";
            this.PbStep1PortBinding.AccessibleRole = System.Windows.Forms.AccessibleRole.Graphic;
            ...
            // PbStep2Firewall
            // 
            this.PbStep2Firewall.AccessibleDescription = "Step two status visualisation.";
            this.PbStep2Firewall.AccessibleName = "Step one status";
            this.PbStep2Firewall.AccessibleRole = System.Windows.Forms.AccessibleRole.Graphic;
            ...
            // PortReservation
            // 
            this.AccessibleDescription = "Executes the port reservation and firewall configuration for the local API.";
            this.AccessibleName = "Port reservation";
